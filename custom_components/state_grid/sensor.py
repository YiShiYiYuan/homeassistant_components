...
SENSOR_TYPES = [
    {"key": "balance", "name": "账户余额", "native_unit_of_measurement": CURRENCY_YUAN, "device_class": SensorDeviceClass.MONETARY, "state_class": SensorStateClass.TOTAL},
    {
        "key": "year_ele_num",
        "name": "年度累计用电",
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback) -> None:
    ...
    for door_account in door_account_list:
        async_add_entities([StateGridSensor(door_account, sensor_type, entry.entry_id, coordinator) for sensor_type in SENSOR_TYPES])
